...
**Each equipped Stack posts its Guidance Bonus.** Given `creature:3` equipping `{Belt of Strength, tier: 1, guidance_bonus: 2, equipped: true, slot: belt}`, *Reconcile Loadout* calls Conditions' *Apply Effect* with `{target_key: str, bonus_type: Enhancement, amount: 2, source_id: "equipment:creature:3:Belt of Strength:belt"}`.
