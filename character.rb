...
class CombatTurn
  attr_reader :rules, :character, :combat_id, :initiative, :mana, :combat_pool, :minor_damage, :moderate_damage, :major_damage, :saturation, :temporary_hit_points, :shock, :conditions, :condition_meta, :ability_damage, :luck_points, :performed_this_turn
